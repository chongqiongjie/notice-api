...
//            System.out.println(manageTemplateService.getSmsTemplate(type,user_id).get(i).getTemplate_content());
//            System.out.println(manageTemplateService.getSmsTemplate(type,user_id).get(i).getTemp_name());
//        }
//    }
//
